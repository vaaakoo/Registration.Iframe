...
{
    public List<KycData> Data { get; set; } = [];
}
...
public class KycData
{
    ...
    public string DocumetType { get; set; } = string.Empty; // typo kept intentionally to match API
    public List<string> SelfImages { get; set; } = [];
