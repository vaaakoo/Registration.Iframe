...
public class CustomerRegistrationRequest
{
    ...
    public List<int> ExpectedTransactionTypes { get; set; } = [];
...
public class CustomerRegistrationResponse { public bool Success { get; set; } }
...
public class FinishCustomerRegistrationRequest
{
    ...
    public int BirthCityId { get; set; } = 0;
    public int BirthCountryId { get; set; }
    public int DualCitizen { get; set; }
    public int SecondaryCitizenshipCountryID { get; set; }
}

public class FinishCustomerRegistrationResponse { public bool Success { get; set; } }
...
public class ChangeCustomerResponse { public bool Success { get; set; } }
